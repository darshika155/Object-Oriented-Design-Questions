...
public class Machine{
    ...
    private static List<Coffee> drinkList = new ArrayList<Coffee>();
    ...
    public static void makeDrink(Coffee drink){
    ...
    public static void addDrink(String name, String[] recipe){
        drinkList.add(new Coffee(name, recipe));
    }
